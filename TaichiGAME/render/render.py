...
class Render():
    ...
    # @staticmethod
    # def rd_shape(gui: GUI, prim: ShapePrimitive) -> None:
    #     assert gui is not None
    ...
    #         Render.rd_point(gui, edg.start + prim._xform)
    #         Render.rd_point(gui, edg.end + prim._xform)
    #         Render.rd_line(gui, edg.start + prim._xform, edg.end + prim._xform)

    #         center: Matrix = (edg.start + edg.end) / 2.0
    #         center += prim._xform
    #         Render.rd_line(gui, center, center + edg.normal * 0.1)
